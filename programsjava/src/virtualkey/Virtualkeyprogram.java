...
public class Virtualkeyprogram {
			...
			public static void main(String[] args)throws IOException, InterruptedException 
			{
				...
				String st;
				File mFolder =new File("D:\\javavirtualkeyfolder");
				mFolder.mkdir();
				String location = "D:\\javavirtualkeyfolder";
			    ...
			    switch(choice) {
			    case 1:
			    	File Fobj = new File("D:\\javavirtualkeyfolder");
			    ...
			    case 2:
				    ...
				    case 3:
				    	...
				    	st = sc.next();
				    	File fsearch = new File("D:\\javavirtualkeyfolder");
